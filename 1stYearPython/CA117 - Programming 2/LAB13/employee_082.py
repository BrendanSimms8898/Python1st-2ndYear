...
class Employee(object):
	...
	def __init__(self, name, hours_worked=0, hourly_rate=9.25):
		self.name, self.employee_number, self.hours_worked, self.hourly_rate = name, Employee.next_employee_number, hours_worked, hourly_rate
	...
	def __str__(self):
		return 'Name: {}\nID: {}\nHours: {:.2f}\nRate: {:.2f}\nWages: {:.2f}'.format(self.name, self.employee_number, self.hours_worked, self.hourly_rate,
